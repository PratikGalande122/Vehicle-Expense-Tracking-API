...
// Paste this file into: lib/data/models/api_models.dart
// ============================================================================
...
enum VehicleType {
  ...
  static VehicleType fromValue(int v) =>
      VehicleType.values.firstWhere((e) => e.value == v, orElse: () => VehicleType.other);
...
enum FuelType {
  ...
  static FuelType fromValue(int v) =>
      FuelType.values.firstWhere((e) => e.value == v, orElse: () => FuelType.petrol);
...
enum ExpenseType {
  ...
  static ExpenseType fromValue(int v) =>
      ExpenseType.values.firstWhere((e) => e.value == v, orElse: () => ExpenseType.other);
...
enum Gender {
  ...
  static Gender? fromValue(int? v) {
    ...
    return Gender.values.firstWhere((e) => e.value == v, orElse: () => Gender.other);
  }
...
enum BloodGroup {
  ...
  static BloodGroup? fromValue(int? v) {
    if (v == null) return null;
    return BloodGroup.values.firstWhere((e) => e.value == v, orElse: () => BloodGroup.oPositive);
  }
...
class SendOtpResponse {
  ...
  final String? otp; // Only present in dev mode when SMTP is not configured
...
/// Matches VehicleExpense.Application.DTOs.Responses.AuthResponse
class AuthResponse {
  final int userId;
  final String name;
  final String email;
...
/// Matches VehicleExpense.Application.DTOs.Responses.UserProfileResponse
...
/// Matches VehicleExpense.Application.DTOs.Requests.UpdateUserProfileRequest
/// Required: mobileNumber, dateOfBirth, bloodGroup, emergencyContact*
class UpdateUserProfileRequest {
  ...
  Map<String, dynamic> toJson() => {
        ...
        if (preferredMechanicName != null) 'preferredMechanicName': preferredMechanicName,
        if (preferredMechanicContact != null) 'preferredMechanicContact': preferredMechanicContact,
        if (preferredHospital != null) 'preferredHospital': preferredHospital,
        if (preferredHospitalContact != null) 'preferredHospitalContact': preferredHospitalContact,
        if (drivingLicenseNumber != null) 'drivingLicenseNumber': drivingLicenseNumber,
        if (licenseExpiryDate != null) 'licenseExpiryDate': licenseExpiryDate!.toIso8601String(),
        if (riderNotes != null) 'riderNotes': riderNotes,
      };
}

/// POST /api/user/profile-image ? request body
class UploadProfileImageRequest {
  final String profileImageUrl;

  const UploadProfileImageRequest({required this.profileImageUrl});

  Map<String, dynamic> toJson() => {'profileImageUrl': profileImageUrl};
}

// ?? Vehicle Models ???????????????????????????????????????????????????????????

/// GET /api/vehicles ? list item
/// POST /api/vehicles ? response
/// PUT /api/vehicles/{id} ? response
/// Matches VehicleExpense.Domain.Entities.Vehicle
class Vehicle {
  final int id;
  final int userId;
  final String name;
  ...
  factory Vehicle.fromJson(Map<String, dynamic> json) => Vehicle(
        ...
        fuelType: FuelType.fromValue(json['fuelType']),
        year: json['year'],
        brand: json['brand'],
        model: json['model'],
        createdAt: DateTime.parse(json['createdAt']),
...
/// Matches VehicleExpense.Application.DTOs.Requests.AddVehicleRequest
...
/// GET /api/fuel ? list item
/// POST /api/fuel ? response
/// Matches VehicleExpense.Domain.Entities.FuelLog
class FuelLog {
  final int id;
  final int vehicleId;
  final int userId;
  ...
  factory FuelLog.fromJson(Map<String, dynamic> json) => FuelLog(
        ...
        filledAt: DateTime.parse(json['filledAt']),
        notes: json['notes'],
        createdAt: DateTime.parse(json['createdAt']),
        updatedAt: json['updatedAt'] != null ? DateTime.parse(json['updatedAt']) : null,
      );
...
/// POST /api/fuel ? request body
/// Matches VehicleExpense.Application.DTOs.Requests.AddFuelRequest
...
/// GET /api/expenses ? list item
/// POST /api/expenses ? response
/// Matches VehicleExpense.Domain.Entities.Expense
class Expense {
  final int id;
  final int vehicleId;
  final int userId;
  ...
  factory Expense.fromJson(Map<String, dynamic> json) => Expense(
        ...
        vehicleId: json['vehicleId'],
        userId: json['userId'],
        expenseType: ExpenseType.fromValue(json['expenseType']),
...
/// Matches VehicleExpense.Application.DTOs.Requests.AddExpenseRequest
...
/// Matches VehicleExpense.Application.DTOs.Responses.VehicleExpenseSummary
...
/// Matches VehicleExpense.Application.DTOs.Responses.DashboardResponse
class DashboardResponse {
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) => DashboardResponse(
        ...
        totalExpenseCost: (json['totalExpenseCost'] as num).toDouble(),
...
/// Standard error response from API (400/404/500)
class ApiErrorResponse {
  final String message;
  final List<String>? errors; // Validation errors from UpdateUserProfileRequest
